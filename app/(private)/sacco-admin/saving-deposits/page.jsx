        ...
        <div className="min-h-screen bg-gray-50/50 p-4 md:p-6 space-y-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-2">
                    <Button
                        ...
                        className="bg-accent hover:bg-[#12345a] text-white text-xs font-semibold px-6 h-10 shadow-lg shadow-blue-100"
                    >
            ...
            <Tabs defaultValue="list" className="w-full">
                <TabsList className="bg-white border p-1 h-12 shadow-sm mb-6">
                    <TabsTrigger value="list" className="px-6 data-[state=active]:bg-slate-50 data-[state=active]:text-[#174271] font-semibold text-xs uppercase tracking-wider">
                        <ListFilter className="w-4 h-4 mr-2" /> All Accounts
                    </TabsTrigger>
                    <TabsTrigger value="bulk-create" className="px-6 data-[state=active]:bg-slate-50 data-[state=active]:text-[#174271] font-semibold text-xs uppercase tracking-wider">
                        <Plus className="w-4 h-4 mr-2" /> Multi-Form Deposit
                    </TabsTrigger>
                    <TabsTrigger value="bulk-upload" className="px-6 data-[state=active]:bg-slate-50 data-[state=active]:text-[#174271] font-semibold text-xs uppercase tracking-wider">
                    ...
                    <Card className="shadow-sm border-none overflow-hidden">
                        <CardHeader className="bg-white border-b px-6 py-4">
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex items-center gap-2 text-[11px] font-semibold text-slate-400 uppercase tracking-widest bg-slate-50 px-3 py-1 rounded-full">
